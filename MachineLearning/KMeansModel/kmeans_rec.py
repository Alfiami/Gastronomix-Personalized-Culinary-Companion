...
Original file is located at
    https://colab.research.google.com/drive/116r0tPh1Raacn6weOmwp5SuMdzfVRANV
"""
...
model = tf.keras.Sequential([
    tf.keras.layers.Dense(64, activation='relu', input_shape=(2,)),  # Menggunakan 2 fitur
...
model.save('recommendation_model_kmeans.h5')
...
with open('recommendation_model_kmeans.tflite', 'wb') as f:
...
interpreter = tf.lite.Interpreter(model_path="recommendation_model_kmeans.tflite")
